...
while(True):
	...
	#therefore this try error statement
        ...
        lower_skin = np.array([150, 69, 100], dtype=np.uint8)
        ...
        #find contours
        wat, contours, hierarchy = cv2.findContours(mask, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
        ...
        for i in range(defects.shape[0]):
            ...
            # they generally come due to noise)
